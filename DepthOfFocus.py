...
print 'The minimum of the original image is %s, the maximum is %s' % (numpy.min(OriginalImage), numpy.max(OriginalImage))
print 'The minimum of the stretched image is %s, the maximum is %s' % (numpy.min(StretchedImage), numpy.max(StretchedImage))
